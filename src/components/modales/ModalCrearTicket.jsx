      ...
      <Modal.Body>
        <Form className='row' onSubmit={handleSubmit}>
            <div className='col-lg'>
                <h5 className='text-uppercase fw-semibold'>Descripcion del Ticket</h5>
                ...
                <p>Si desea enviar mas de un archivo, seleccione una carpeta comprimida</p>
            </div>
            <div className='col-lg'>
                ...
                <Form.Control type='submit' value={"Enviar Ticket"} className='bg-azulOscuro text-white'/>
                <ToastContainer autoClose={1500} transition: Slide  hideProgressBar theme="colored"/>
            </div>
        </Form>
      </Modal.Body>
    </Modal>
