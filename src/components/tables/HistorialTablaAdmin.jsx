    ...
    <div className="w-100 mx-1 p-4 bo  rder border-black rounded mb-2">
      ...
      {Tickets.length != 0 ? (
        <Table responsive="md">
          <thead>
            <tr>
              <th className="bg-celeste fw-medium">Servicio</th>
              <th className="bg-celeste fw-medium">Fecha</th>
              <th className="bg-celeste fw-medium">Encargado</th>
            </tr>
          </thead>
          <tbody>
        ...
        <div>No hay Tickets Creados</div>
      )}
    </div>
  );
